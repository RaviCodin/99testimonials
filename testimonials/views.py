...
from .serializers import (
    ...
    TestimonialImageSerializer,
    TestimonialVideoSerializer,
)
...
class IsOwnerOrCollaborator(permissions.BasePermission):
    def has_object_permission(self, request, view, obj):
        return (
            ...
            or request.user in obj.project.collaborators.all()
        )
...
class TestimonialViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if campaign_id:
            if campaign_id == "all":
                ...
                print("fuck")
                queryset = queryset.filter(source="Import").order_by("-created")
            else:
    ...
    def create_or_update_customer(self, testimonial):
        ...
        uid = (
            email
            if email
            else "".join(random.choices(string.ascii_letters + string.digits, k=255))
        )
    ...
    def perform_update(self, serializer):
        ...
        if (
            ...
            and self.request.user not in project.collaborators.all()
        ):
            return Response(
                {
                    "error": "You do not have permission to update testimonials for this project."
                },
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        if (
            ...
            return Response(
                {
                    "error": "You do not have permission to delete testimonials for this project."
                },
                status=status.HTTP_403_FORBIDDEN,
            )
    ...
    def upload_csv(self, request, *args, **kwargs):
        ...
        return Response(
            {"status": "CSV uploaded successfully"}, status=status.HTTP_201_CREATED
        )
...
class SampleCSVView(APIView):
    def get(self, request, *args, **kwargs):
        ...
        response["Content-Disposition"] = (
            'attachment; filename="sample_testimonials.csv"'
        )
...
class UploadCSVView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {"status": "Invalid JSON format"}, status=status.HTTP_400_BAD_REQUEST
            )
...
class ImportTestimonialView(APIView):
    def post(self, request, project_id, *args, **kwargs):
        ...
        if "instagram.com" in url:
            ...
            return Response(
                {"error": "Unsupported URL"}, status=status.HTTP_400_BAD_REQUEST
            )
        ...
        try:
            ...
            return Response(
                {
                    "status": "Testimonial imported successfully",
...
def update_testimonial_highlights(request, testimonial_id):
    ...
    return Response(
        {"status": "success", "message": "Highlights updated successfully."},
